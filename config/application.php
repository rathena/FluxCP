...
return array(
	...
	'AllowDuplicateEmails'		=> 0,						// Number of same e-mail address can be used in registration. 0 Means disallow duplication, -1 unlimited duplication. (See Mailer config options)
	'UseWhitelistEmailDomains'	=> false,					// Enable this config only allow registration by using e-mail from domain listed in WhitelistEmailDomains config.
...
// Discord Webhooks
	...
	// Only allowed e-mail from this domains
	'WhitelistEmailDomains'			=> include('whitelistemaildomains.php'),
