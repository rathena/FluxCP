...
use rAthena\FluxCp\RegisterError;
	...
	try {
		...
		switch ($e->getCode()) {
			...
			case RegisterError::INVALID_USERNAME:
				...
				break;
			case RegisterError::INVALID_PASSWORD:
				$errorMessage = Flux::message ('InvalidPassword');
				break;
			case RegisterError::INVALID_BIRTHDATE:
