...
//			Respond and Return to Ticket: <input type="radio" name="secact" value="1"/><br />
//			Respond and Return to List: <input type="radio" name="secact" value="2"/><br />
//			Respond and Resolve Ticket: <input type="radio" name="secact" value="3"/><br />
//			Escalate: <input type="radio" name="secact" value="4"/><br />
//			Close Ticket: <input type="radio" name="secact" value="5"/><br />
//			Respond and Re-Open Ticket: <input type="radio" name="secact" value="6"/><br />
	if($_POST['secact']=='1'){
