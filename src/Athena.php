...
class Athena
{
	 ...
	 * @param Config $charMapConfig
	 * @param LoginServer $loginServer
	 * @param CharServer $charServer
	 * @param MapServer $mapServer
	 * @access public
	 */
	public function __construct(Config $charMapConfig, LoginServer $loginServer, CharServer $charServer, MapServer $mapServer)
	{
		...
		if ($woeDayTimes instanceOf Config) {
		...
		$_tempArray = array();
		$this->woeDisallow = new Config($_tempArray);

		if ($woeDisallow instanceOf Config) {
	 ...
	 */
	public function setLoginAthenaGroup(LoginAthenaGroup $loginAthenaGroup)
	{
	 ...
	 *
	 * @param int $charID
	 * @return mixed Returns rAthena\FluxCp\Flux_DataObject or false.
	 */
	 ...
	 * @return mixed rAthena\FluxCp\Flux_Config or false.
	 */
