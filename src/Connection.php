...
use PDO;
use rAthena\FluxCp\Connection\Statement;
...
class Connection
{
	 ...
	 * @param Config $logsDbConfig
	 * @access public
	 */
	public function __construct(Config $dbConfig, Config $logsDbConfig)
	{
	 ...
	 * @access private
	 */
	private function connect(Config $dbConfig)
	{
		$dsn = 'mysql:';
	...
	public function getStatement($statement, $options = array())
	{
		...
		@$sth->setFetchMode(PDO::FETCH_CLASS, 'rAthena\FluxCp\DataObject', array(null, array('dbconfig' => $this->dbConfig)));
	...
	public function getStatementForLogs($statement, $options = array())
	{
		...
		$sth = $dbh->prepare($statement, $options);
		@$sth->setFetchMode(PDO::FETCH_CLASS, 'rAthena\FluxCp\DataObject', array(null, array('dbconfig' => $this->logsDbConfig)));
